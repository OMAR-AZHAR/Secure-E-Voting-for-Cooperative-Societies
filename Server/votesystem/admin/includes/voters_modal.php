  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" method="POST"  action="votermod_add.php" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input autocomplete="new-password" type="email" placeholder="Email" class="form-control" id="email" name="email" required>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input autocomplete="new-password" pattern="(?!0+)\d+"  maxlength="13" title="13 Digit CNIC" type="tel"  placeholder="13 Digit CNIC" class="form-control" id="CNIC" name="CNIC" required>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input autocomplete="new-password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one  number, one character and 8 characters" type="password" class="form-control" id="password" name="password" required>
            </div>
          </div>
          <div class="form-group">
...
<div class="modal fade" id="edit">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form  autocomplete="off" class="form-horizontal" method="POST" action="voters_edit.php">
          ...
          <div class="form-group">
								 <label for="Phone#" class="col-sm-3 control-label">Mobile Number# <i style="color:#ef9300"> (03xx-xxxxxxx)</i></label>
