                ...
                <tbody>
                  <?php
                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      $image2 = (!empty($row['ESI'])) ? '../images/'.$row['ESI'] : '../images/ESI.jpg';
                      $filename3 = (!empty($row['Docs'])) ? '../images/'.$row['Docs'] : '../images/Docs.jpg';
                      echo "
                        <tr>
                          <td class='hidden'></td>
                          ...
                          <td>
                          <img src='".$image2."' width='30px' height='30px'>
                          <a href='#edit_photo2' data-toggle='modal' class='pull-right photo' data-id='".$row['canid']."'><span class='fa fa-edit'></span></a>
                        </td>
                          <td>".$row['firstname']."</td>
                          <td>".$row['lastname']."</td>
                          <td>
                         
                          <img src='".$filename3."' width='30px' height='30px'>
                          <a href='#edit_photo3' data-toggle='modal' class='pull-right photo' data-id='".$row['canid']."'><span class='fa fa-edit'></span></a>
                        </td>
...
$(function(){
  ...
  $(document).on('click', '.ESI', function(e){
    e.preventDefault();
    var id = $(this).data('id');
    getRow(id);
  });
