				        		...
				        		<?php
									...
									while($row = $query->fetch_assoc()){
										...
										while($crow = $cquery->fetch_assoc()){
											...
											$candidate .= '
												<li>
													'.$input.'<button type="button" class="btn btn-primary btn-sm btn-flat clist platform" data-platform="'.$crow['platform'].'" data-fullname="'.$crow['firstname'].' '.$crow['lastname'].'"><i class="fa fa-search"></i> Platform</button><img src="'.$image.'" height="60px" width="60px" class="clist"><span class="cname clist">'.$crow['firstname'].' '.$crow['lastname'].'<img src="'.$image2.'" height="80px" width="80px" class="clist"></span>
												</li>
											';
										}
