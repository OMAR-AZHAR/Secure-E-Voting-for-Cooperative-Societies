      ...
      <div class="modal-body">
        <form class="form-horizontal" method="POST" action="voters_add.php" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input autocomplete="new-password" pattern="^\d{5}-\d{7}-\d{1}$" title="13 Digit CNIC" type="tel" data-inputmask="'mask': '99999-9999999-9'" placeholder="13 Digit CNIC" class="form-control" id="CNIC" name="CNIC" required>
            </div>
          </div>
          <div class="form-group">
